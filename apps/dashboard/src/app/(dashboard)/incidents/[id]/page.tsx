...
export default function IncidentDetailPage({
  ...
  return (
    <>
      <PageHeader
        title={item.title}
        description={`${item.service.name} · ${item.service.environment}`}
        action={
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm font-medium">{formatDate(item.lastSeenAt)}</p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="timeline">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Incident lifecycle events.</CardDescription>
            </CardHeader>
            <CardContent>
