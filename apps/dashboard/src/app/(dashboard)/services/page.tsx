...
export default function ServicesPage() {
  ...
  return (
    <>
      <PageHeader
        title="Services"
        description="Auto-registered services and their current health."
      />
      <Card>
        <CardContent>
                  ...
                  <TableRow key={service.id}>
                    ...
                    <TableCell>
                      <div className="flex flex-wrap gap-1">
                        {service.sourceTypes.map((source) => (
          ...
          {!query.isLoading && !query.data?.length && (
            <p className="py-16 text-center text-sm text-muted-foreground">
              No services registered. Send a log with a server API key to get
              started.
            </p>
          )}
        </CardContent>
