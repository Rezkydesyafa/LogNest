...
export type DashboardSummary = {
  ...
  topErrorServices: Array<{ serviceId: string; serviceName: string; errorCount: number }>
  slowestApiEndpoints: Array<{ path: string; method: string; avgDurationMs: number; errorCount: number }>
  recentIncidents: Array<Pick<Incident, "id" | "title" | "severity" | "status" | "lastSeenAt"> & { serviceName: string }>
}
