...
export const INCIDENT_ANALYSIS_QUEUE = 'incident-analysis';
export const REQUEST_ID_HEADER = 'x-request-id';
export const DEFAULT_DATABASE_URL = 'postgresql://logmind:logmind@localhost:5432/logmind?schema=public';
